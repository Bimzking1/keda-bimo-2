...
const ContactUs = () => {
    ...
    const sendEmail = (e) => {
        ...
        .then((result) => {
            toast.success('Message successfully sent to Keda Enterprise (paulbimos@gmail.com)', {
                position: "top-center",
                autoClose: 5000,
    ...
    return (
        <div className='pb-16 w-full xl:w-[1280px] flex flex-col items-center'>
            ...
            <div className='flex flex-col lg:flex-row w-full md:px-8'>
                <div className='p-8 mr-16 text-xl w-full md:rounded-3xl bg-[#6C63FF]'>
                    <form 
                        ref={form} 
                        onSubmit={sendEmail}
                    ...
                    >
                        ...
                        <div className='flex items-center justify-center md:justify-start'>
                            <button className='font-semibold text-gray-800 hover:text-gray-100 mt-8 py-4 w-fit px-8 md:px-16 rounded-full bg-gray-100 hover:bg-[#01B7FE] duration-300' type="submit" value="Send">
                                Send Message
                            </button>
                        </div>
                    </form>
            ...
            <div>
                ...
                <div className='flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16'>
                    ...
                    <a href='https://www.instagram.com/keda_tech/' target="_blank" className='hover:bg-gray-200 duration-300 flex items-center justify-center bg-white px-8 py-4 rounded-full'>
                        <div className='w-[60px]'>
                            <img
                                src={Instagram}
                                className=''
